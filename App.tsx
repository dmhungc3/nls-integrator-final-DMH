...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6 font-sans text-slate-900 flex flex-col items-center">
      ...
      {/* --- STICKY HEADER (Tác giả + Tên sản phẩm) --- */}
      <div className="sticky top-0 z-50 w-full max-w-7xl transition-all">
          ...
          <div className="pt-3 pb-3 px-4 flex flex-col gap-3">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex items-center gap-4 group cursor-pointer">
                      <div className="relative w-10 h-10 bg-indigo-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-indigo-200 shrink-0 ring-2 ring-white group-hover:scale-105 transition-transform">
                          <User className="w-5 h-5" />
                      </div>
                      <div className="flex flex-col">
                          <h2 className="font-bold text-slate-800 text-sm group-hover:text-indigo-700 transition-colors">Tác giả: Đặng Mạnh Hùng</h2>
                          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[10px] text-slate-500 font-medium mt-0.5">
                  ...
                  <div className="flex items-center justify-end">
                      {isKeySaved ? (
                          <div className="flex items-center gap-3 bg-white p-1 pl-3 pr-1.5 rounded-full border border-emerald-100 shadow-sm">
                              ...
                              <button onClick={handleEditKey} className="px-3 py-1 rounded-full bg-slate-100 text-slate-500 text-[10px] font-bold hover:bg-slate-200">Đổi</button>
                          </div>
                      ) : (
      ...
      {/* --- FOOTER (CHÂN TRANG) - ĐÃ ĐƯỢC THÊM --- */}
